# -*- coding: utf-8 -*-
"""Frame-by-frame 2D animation: Martin 'surprised'.

Surprise timing = snap in, hold, release slowly.  The reaction reaches its
extreme in 2 frames, jitters slightly while held, then eases back to neutral.
"""
import bpy, os, math

SRC = r"E:/001_MAKETHEMFALLinlove素材庫/blender/develop/Martin/frames_surprised/s_%02d.png"
NF = 6
PLANE_H = 4.40
PLANE_Y = 0.50
FPS = 24
...
# (drawing index, frames held)  0 neutral ... 5 fully surprised
TL = [(0, 12),
      (1, 1), (3, 1),                       # snap: 2 frames to the extreme
      (5, 9), (4, 2), (5, 5), (4, 3), (5, 4),   # hold with a small startle jitter
      (3, 5), (2, 6), (1, 6), (0, 14)]      # ease back to neutral
...
sc.frame_set(1)
print("surprised: %d drawings, %d frames (%.2fs), %d cuts"
      % (NF, LAST, LAST / float(FPS), len(TL)))
