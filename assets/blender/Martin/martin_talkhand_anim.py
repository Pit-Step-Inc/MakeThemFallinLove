# -*- coding: utf-8 -*-
"""Frame-by-frame 2D animation: Martin talking with his hand raised.

The eight drawings are not a drawn cycle - they are eight separate takes of the
same pose - so the order here is authored rather than "as drawn".  The frames
come from talkhand_prep.py, which freezes everything but the mouth, so drawing
0/6 = mouth shut, 3 = wide open, 1/2/5/7 = part open, 4 = part open with the
eyes shut (the one blink).

HOLD sets the tempo: 2 = fast (12 drawings/sec), 3 = calm (8/sec).
"""
import bpy, os, math, glob

SRC = r"E:/001_MAKETHEMFALLinlove素材庫/blender/develop/Martin/frames_talkhand/h_%02d.png"
NF = len(glob.glob(os.path.dirname(SRC) + "/h_*.png"))
PLANE_H = 4.40
PLANE_Y = 0.50
FPS = 24
PREFIX = "MartinHand_"

# (drawing, frames held).  3 on the shut-mouth beats so the phrases breathe,
# 3 on the blink so it does not read as a flicker.
TL = [
    (0, 3), (2, 2), (3, 2), (1, 2), (6, 3), (5, 2), (3, 2), (7, 2),
    (0, 3), (1, 2), (3, 2), (2, 2), (6, 3), (7, 2), (3, 2), (5, 2),
    (0, 3), (2, 2), (4, 3), (3, 2), (6, 3), (1, 2), (7, 2), (2, 2),
    (0, 3), (5, 2), (3, 2), (2, 2), (6, 3), (1, 2), (7, 2), (0, 4),
]
...
sc.frame_set(1)
print("talk_hand: %d drawings, %d cuts, %d frames (%.2fs)"
