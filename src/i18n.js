...
export const STRINGS = {
  en: {
    ...
    joinRoom:          "Join",
    roomHint:          "Play as the host, or join with the code your host gave you",
    // 縦向きのときの案内（src/rotate.js）
    rotateText:        "Turn your phone sideways",
    rotateBtn:         "Go landscape",
    rotateHint:        "If it will not turn, switch off the rotation lock",
    ...
    // 先に着いた人（ホスト以外）に出す札。ホストには startNow が出る
    waitingOthers:     "Waiting for the other players",
    startNow:          "Start now",
    generating:        "What happens next?",
    // 未来（10年後・20年後・30年後）を作っているあいだだけの見出し。
    // ここはもう「次の展開」ではなく、二人のその後を見に行く場面
    generatingFuture:  "Where are Martin and Catherine ten years later?",
    // その Prompt では絵を描けなかった回。AI が別の出来事を考え直している
    generatingBlocked: "That one could not be drawn - thinking up something else...",
  ...
  ja: {
    ...
    joinRoom:          "参加",
    roomHint:          "ホストとしてプレイするかホストから聞いたコードを入力して参加",
    rotateText:        "スマホを横向きにしてください",
    rotateBtn:         "横画面にする",
    rotateHint:        "回らないときは、画面の向きのロックを解除してください",
    ...
    waitingOthers:     "ほかのプレイヤーを待っています",
    startNow:          "先に始める",
    generating:        "次はどうなる？",
    generatingFuture:  "あれから10年後マーティンとキャサリンはどうなった？",
    generatingBlocked: "その展開は描けませんでした。別の出来事を考えています…",
